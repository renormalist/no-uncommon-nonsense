...
THIS VERSION IS A VARIANT WHICH TRIES TO SENSIBLY HANDLE NEWER
PERL VERSIONS IN WHICH FEATURES GOT DEPRECATED. CURRENTLY IT TESTS
for 'switch' and imports 'Switch::Back' instead when Perl version
is 5.41+.
